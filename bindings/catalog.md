...
## 列: ts-react-web@7 — TypeScript + React（Web/PWA・Vite・Supabase想定）【要実測】
...
## 列: dart-flutter@5 — Dart（Flutter・app/ 層）【ゲート系=移植元で実測済み／ランタイム系=要実測】
...
## 列: rust@5 — Rust（engine/ 層・ソルバー等）【ゲート系=移植元で実測済み／ランタイム系=要実測】
