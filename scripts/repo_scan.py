...
REQUIRED_PATHS = [
    ...
    ".claude/hooks/guard_git_bypass.sh", ".claude/hooks/post_edit_format.sh",
    ".claude/hooks/post_edit_lint.sh", ".claude/hooks/stop_incomplete_guard.sh",
    ".claude/hooks/session_baseline.sh", ".claude/hooks/guard_human_wip.sh",
...
BINDING_STAMP_FILES = [
    ...
    ".github/workflows/guardrails-ci.yml",
    ".claude/hooks/post_edit_format.sh",
