...
> 前提: LLM = Claude Code。採用が確定した項目だけが GUARDRAILS.md §10（保留/Phase）へ
...
## 6. 保留（トリガーを明記して寝かせる——採用時は GUARDRAILS.md §10 保留節へ転記）
...
本書 §6 の保留4件をトリガー付きで GUARDRAILS.md §10 保留節へ転記し、§1 の採用ゲート
